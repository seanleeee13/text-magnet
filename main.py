...
ltitle_lbl.place(relx=0.5, rely=0.2, anchor="n")
login_form = Frame(loginp)
login_form.place(relx=0.5, rely=0.4, anchor="n")
...
lss = Frame(loginp)
lss.place(relx=0.5, rely=0.5, anchor="n")
...
stitle_lbl.place(relx=0.5, rely=0.2, anchor="n")
signup_form = Frame(signupp)
signup_form.place(relx=0.5, rely=0.4, anchor="n")
...
sss = Frame(signupp)
sss.place(relx=0.5, rely=0.535, anchor="n")
